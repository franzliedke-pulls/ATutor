...
$this->_pages['mods/_standard/tests/view_results.php']['children']  = array(); // to create the "back to tests" link
	...
	$this->_pages['mods/_standard/tests/create_question_fillblank.php']['title_var'] = 'create_new_question';
	$this->_pages['mods/_standard/tests/create_question_fillblank.php']['parent']    = 'mods/_standard/tests/question_db.php';
	...
	$this->_pages['mods/_standard/tests/edit_question_fillblank.php']['title_var'] = 'edit_question';
	$this->_pages['mods/_standard/tests/edit_question_fillblank.php']['parent']    = 'mods/_standard/tests/question_db.php';

...
?>
<form action="mods/_standard/tests/create_question_fillblank.php" method="post" name="form">

<div class="input-form">
    <fieldset class="group_form"><legend class="group_form"><?php echo _AT('test_fb'); ?></legend>
    <div class="row">
